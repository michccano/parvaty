      ...
      <div class="container-fluid">
        ...
        <div class="card card-info">
              ...
              <form id="addhuddle" class="form-horizontal" >
                <div class="card-body">
                  <p class="text-sm">Complete the following fields to start a new huddle up.</p>
                  <div class="form-group row">

                    <label for="inputEmail3" class="col-sm-2 col-form-label">Title</label>
                    <div class="col-sm-10">
                      <input type="email" class="form-control" id="title" placeholder="Email" name="title">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="sub-title" placeholder="" name="sub-title">
                    </div>
                  </div>

                     <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Huddle-Up Types</label>
                    <div class="col-sm-10">
                    <select class="form-control">
                          <option>Information Sharing</option>
                          <option>Brainstorming</option>
                          <option>Problem</option>
                          <option>Manager updates</option>
                     ...
                     <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Criteria To Close</label>
                    <div class="col-sm-10">
                    <select class="form-control">
                    ...
                    <div class="col-sm-10">
                 <input type="file" class="custom-file-input" id="details">
                ...
                <div class="card-footer">
                  <center>
                  <button onclick="addHuddle()" type="button" class="btn btn-info">Huddle Up!</button>
                </center>
                </div>
                <!-- /.card-footer -->
              </form>
